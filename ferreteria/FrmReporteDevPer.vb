...
Public Class FrmReporteDevPer
    ...
    Private Sub FrmReporteDevPer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        conexion.Open()
    ...
    Private Sub btnMostrar_Click(sender As Object, e As EventArgs) Handles btnMostrar.Click
        ...
        Adaptador.SelectCommand.CommandText = "devolucionesPersonal"
        ...
        frmReportes.ReportViewer1.LocalReport.ReportPath = "D:\je_ss\Escritorio\tareas\SIS. INTEGRALES\ferreteria\ferreteria\ferreteria\Reporte-devoluciones-personal.rdlc"
